...
- PTKG: 55 tests, typecheck passing locally on Node 24 (rechecked 2026-08-17).
...
- Current cgroup authoring run: projection validation passes with 21 nodes, 29 edges and 27 sources; authoring validation has four blockers because mount S0, pids S2 and seeded-fault S3 lack succeeded execution results and the persisted S0 cleanup/reset did not succeed. The split is reviewable, not release-ready.
